...
final class GetGlobalBounceRate extends Command
{
    protected static $defaultName = 'ga:global-bounce:fetch';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $gaData = $analytics->data_ga->get(
            ...
            '7daysAgo',
            'today',
            'ga:bounceRate,ga:avgSessionDuration',
        );

        $table = new Table($output);
        $table
            ->setHeaders(['Global bounce rate', 'Average session duration'])
